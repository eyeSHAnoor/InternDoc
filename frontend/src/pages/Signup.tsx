...
export default function Signup() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch("http://127.0.0.1:8000/api/register/", { // Django signup endpoint
                method: "POST",
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 relative">
            ...
            <div className="w-full max-w-md">
                <div className="bg-white w-[608px] h-[600px] rounded-2xl shadow-xl p-8 border border-gray-200">
                    <h2 className="text-3xl font-bold text-gray-900 text-center mb-2">Create Account</h2>
                    <p className="text-gray-500 text-center mb-12">
                        Register to our service to bs able to invite client
                    </p>
